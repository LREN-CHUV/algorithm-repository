...
[ $(git tag --points-at HEAD | grep python-jsi-hedwig | wc -l) == 1 ] || (
...
## Notify Microbadger
curl -XPOST https://hooks.microbadger.com/images/hbpmip/python-jsi-hedwig/5i_C8kswHjEz1zQ9Xfe0sulHPc4=
