...
[ $(git tag --points-at HEAD | grep java-jsi-clus-pct-ts | wc -l) == 1 ] || (
...
## Notify Microbadger
curl -XPOST https://hooks.microbadger.com/images/hbpmip/java-jsi-clus-pct-ts/H0gB-LPzhTkFcQofYqFTMa_VUnk=
