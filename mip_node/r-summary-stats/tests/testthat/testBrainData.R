...
test_that("We can perform summary statistics on one variable", {
  ...
  expect_equal(tv1_min,    0.0068206, tolerance = 1e-6);
  expect_equal(tv1_q1,     0.00857095, tolerance = 1e-6);
  expect_equal(tv1_median, 0.00931775, tolerance = 1e-6);
  expect_equal(tv1_q3,     0.009805875, tolerance = 1e-6);
  expect_equal(tv1_max,    0.011463, tolerance = 1e-6);
  expect_equal(tv1_mean,   0.0091911, tolerance = 1e-6);
  expect_equal(tv1_std,    0.00087956, tolerance = 1e-6);
  expect_equal(tv1_sum,    0.9191096, tolerance = 1e-6);
