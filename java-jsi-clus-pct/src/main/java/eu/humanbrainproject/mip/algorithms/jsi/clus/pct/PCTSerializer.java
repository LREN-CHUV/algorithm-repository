...
public class PCTSerializer extends ClusGenericSerializer<ClusNode> {
	...
	// @Override
	// public void writeModelConstants(ClusNode model, JsonGenerator jgen)
	// throws IOException {
	//
	...
	// {
	// Schema schema = SchemaBuilder.record("LinearModel").doc("The model
	// parameter").fields()
	...
	/*
	 * 
	 * @Override public void writePfaAction(M model, JsonGenerator jgen) throws
	 * IOException { // Empty expression, to override if necessary }
	 * 
	 * public void writePfaEnd(M model, JsonGenerator jgen) throws IOException {
	 * // Empty expression, to override if necessary }
	 * 
	 * public void writePfaFunctionDefinitions(M model, JsonGenerator jgen)
	 * throws IOException { // Empty set of functions, to override if necessary
	 * }
	 * 
	 * 
	 */
