...
[ $(git tag --points-at HEAD | grep java-jsi-clus-pct | wc -l) == 1 ] || (
...
## Notify Microbadger
curl -XPOST https://hooks.microbadger.com/images/hbpmip/java-jsi-clus-pct/qL9YEShLJRp1Yttlr6JtdMGRh4c=
