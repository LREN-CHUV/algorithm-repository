...
[ $(git tag --points-at HEAD | grep java-jsi-clus-fire | wc -l) == 1 ] || (
...
## Notify Microbadger
curl -XPOST https://hooks.microbadger.com/images/hbpmip/java-jsi-clus-fire/0nnFopl4hixQ6IlM1n7BsRie1uk=
