...
[ $(git tag --points-at HEAD | grep java-rapidminer-naivebayes | wc -l) == 1 ] || (
...
# Notify Microbadger
curl -XPOST https://hooks.microbadger.com/images/hbpmip/java-rapidminer-naivebayes/o8APsDzhJaoF_ZWLZ2to4x0x_LM=
